...
class Dimens {
  ...
  static const double groupGap = 20; // 18–22px between logical groups

  // Card / sheet padding
  static const double cardPadding = 16; // 14–18px
  static const double cardPaddingTight = 14;
  static const double sheetPadding = 20;

  // Radius
  static const double radiusCard = 14;
  static const double radiusLargeCard = 18; // 16–20px
  static const double radiusSheetTop = 24;
  static const double radiusButton = 14; // 12–16px
  ...
  // Nav
  static const double bottomNavItem = 60;
